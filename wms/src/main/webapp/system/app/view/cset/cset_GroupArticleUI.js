 ...
 * 创建：hekl
 */
var cset_GroupArticleStore=Ext.create('cms.store.cset.cset_GroupArticleStore',{autoLoad:true});
Ext.define('cms.view.cset.cset_GroupArticleUI',{
	alias:'widget.cset_GroupArticleUI',
	title:$i18n.title2401,//商品类别货位对照关系
	layout:'border',
	requires:[
