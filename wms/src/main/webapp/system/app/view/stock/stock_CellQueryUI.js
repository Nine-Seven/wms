Ext.define('cms.view.stock.stock_CellQueryUI', {
	alias : 'widget.stock_CellQueryUI',
	title:'货位库存查询',
	width : '100%',	
	layout : 'border',
