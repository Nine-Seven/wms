...
Ext.define('cms.view.odata.odata_ExpForAllotUI',{
	alias:'widget.odata_ExpForAllotUI',
	title:$i18n.title3104,//出货手建单
	width:'100%',
	layout:'border',
	    	...
	    	items:[
	    		...
	    		items :[{
				    ...
				    items:[{
						...
						store:Ext.create('cms.store.bdef.bdef_DefOwnerComboStore',{
		    				...
		    				listeners:{
								...
								{
									if(Ext.getCmp('exp_type3104_query').getStore().data.length>0)
									{
										Ext.getCmp('exp_type3104_query').setValue(Ext.getCmp('exp_type3104_query').getStore().getAt(0).data.value);		
									}
								}
							}
						}).load()
					...
					},
                    {
						...
						id:'po_nomark3104_query',
						maxLength:20
					},{
					 	xtype:'wms_DefFieldValCombo',
					    fieldLabel : $i18n.take_type,// 提货类型
						id : 'takeType3104_query',	
						...
						id:'deliver_no3104_query',
						maxLength:100
			  		},{
						xtype:'wms_DefFieldValCombo',
	    	    		fieldLabel:$i18n.Order_source,//订单来源
	    	    		id:'Order_source3104_query',
	    	    		store:Ext.create("cms.store.common.comboStore").load(
	    	    		{
						...
						fieldLabel:'品项数',
						id:'skucount3104_query'
					},{
						fieldLabel:'平台订单号',
						id:'custExpNo3104_query'
					},{
						fieldLabel:'发货人',
						id:'sendName3104_query'
					
					},{
						fieldLabel:'收货人',
						id:'receiveName3104_query'
					
					},{
						fieldLabel:'提货人',
						id:'takeName3104_query'
	    	...
	    	items:[
	    	{
			    ...
			    items : [{
			    	...
			    	items:[
					{
			    	    ...
			    	    items :[
		    	    	{
							...
							id:'Deliver_address3104',
							readOnly:true,
							maxLength:100
				  		},{
							xtype:'wms_DefFieldValCombo',
		    	    		fieldLabel:$i18n.Print_bill_flag,//是否打印发票
		    	    		id:'Print_bill_flag3104',
		    	    		store:Ext.create("cms.store.common.comboStore").load(
		    	    		{ 
			    	...
			    	items:[
					{
			    	    ...
			    	    items :[
		    	    	{
							...
							fieldLabel:'提货人电话',
							readOnly:true,
							id:'take_mobile_phone3104',
							maxLength:50
				  		},{
							fieldLabel:'提货人固定电话',
							readOnly:true,
							id:'take_telephone3104',
							maxLength:100
				  		},{
							fieldLabel:'提货人邮箱',
							readOnly:true,
							id:'take_postcode3104',
							maxLength:50
				  		},{
							fieldLabel:'提货公司名称',
							readOnly:true,
							id:'take_company_name3104',
							maxLength:100
				  		},{
							fieldLabel:'提货人国家二字码',
							readOnly:true,colspan:3,
			    	...
			    	items:[
					{
			    	    ...
			    	    items :[
		    	    	{
							...
							fieldLabel:'发货人电话',
							readOnly:true,
							id:'send_mobile_phone3104',
							maxLength:50
				  		},{
							fieldLabel:'发货人固定电话',
							readOnly:true,
							id:'send_telephone3104',
							maxLength:100
				  		},{
							fieldLabel:'发货人邮箱',
							readOnly:true,
							id:'send_postcode3104',
							maxLength:50
				  		},{
							fieldLabel:'发货公司名称',
							readOnly:true,
							id:'send_company_name3104',
							maxLength:100
				  		},{
							fieldLabel:'发货人国家二字码',
							readOnly:true,colspan:3,
	    	    	...
	    	    	listeners:{
	    	    		'load':function(th,records,successful,eOpts ){
	    	    			var arrayObj = new Array();
         					...
         					arrayObj[2]='planDis';
         					arrayObj[3]='unitCost';
         					countList('grid_02_3104',arrayObj,'articleNo');
	    	    		}
	    	    	}
	    	    }),
	    	    selModel : {
	    	    ...
	    	    plugins : [Ext.create('Ext.grid.plugin.CellEditing', {
	    	        ...
	    	        onSpecialKey:function(ed,field,e){
						commEnterGridStatEdit(this.grid,true,'cms.controller.odata.odata_ExpForAllotController',e.getKey());
					}
	    	    })],
	    	    columns : [
	    	    {
