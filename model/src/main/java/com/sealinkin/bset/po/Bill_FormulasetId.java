...
/**
 * BillFormulasetId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Bill_FormulasetId implements java.io.Serializable {
	...
	/** default constructor */
	public Bill_FormulasetId() {
	}

	/** full constructor */
	public Bill_FormulasetId(String enterpriseNo, String warehouseNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Bill_FormulasetId))
			return false;
		Bill_FormulasetId castOther = (Bill_FormulasetId) other;
