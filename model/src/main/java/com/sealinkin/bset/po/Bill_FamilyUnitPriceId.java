...
/**
 * BillFamilyUnitPriceId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Bill_FamilyUnitPriceId implements java.io.Serializable {
	...
	/** default constructor */
	public Bill_FamilyUnitPriceId() {
	}

	/** full constructor */
	public Bill_FamilyUnitPriceId(String warehouseNo, String ownerNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Bill_FamilyUnitPriceId))
			return false;
		Bill_FamilyUnitPriceId castOther = (Bill_FamilyUnitPriceId) other;
