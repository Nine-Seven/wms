...
/**
 * CostAccountDiscountId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Cost_AccountDiscountId implements java.io.Serializable {
	...
	/** default constructor */
	public Cost_AccountDiscountId() {
	}

	/** full constructor */
	public Cost_AccountDiscountId(String warehouseNo, String ownerNo,
			String accountNo, String accountLadder, String enterpriseNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Cost_AccountDiscountId))
			return false;
		Cost_AccountDiscountId castOther = (Cost_AccountDiscountId) other;
