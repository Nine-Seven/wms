...
/**
 * CostAccountFormulaId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Cost_AccountFormulaId implements java.io.Serializable {
	...
	/** default constructor */
	public Cost_AccountFormulaId() {
	}

	/** full constructor */
	public Cost_AccountFormulaId(String enterpriseNo, String warehouseNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Cost_AccountFormulaId))
			return false;
		Cost_AccountFormulaId castOther = (Cost_AccountFormulaId) other;
