...
/**
 * WmsOwnerOutorderFlow entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "WMS_OWNER_OUTORDER_FLOW")
public class Wms_OwnerOutorderFlow implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private Wms_OwnerOutorderFlowId id;
	...
	/** default constructor */
	public Wms_OwnerOutorderFlow() {
	}

	/** minimal constructor */
	public Wms_OwnerOutorderFlow(Wms_OwnerOutorderFlowId id) {
		this.id = id;
	}

	/** full constructor */
	public Wms_OwnerOutorderFlow(Wms_OwnerOutorderFlowId id, Short flowValue,
	...
	public Wms_OwnerOutorderFlowId getId() {
		return this.id;
	}

	public void setId(Wms_OwnerOutorderFlowId id) {
		this.id = id;
	}
