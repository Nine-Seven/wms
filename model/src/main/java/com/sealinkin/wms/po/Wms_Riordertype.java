...
/**
 * WmsRiordertype entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "Wms_Riordertype")
public class Wms_Riordertype implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 1L;
	private Wms_RiordertypeId id;
	...
	/** default constructor */
	public Wms_Riordertype() {
	}

	/** minimal constructor */
	public Wms_Riordertype(Wms_RiordertypeId id, String overQtyFlag,
	...
	public Wms_RiordertypeId getId() {
		return this.id;
	}

	public void setId(Wms_RiordertypeId id) {
		this.id = id;
	}
