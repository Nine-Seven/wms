...
/**
 * WmsDefreportId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Wms_DefreportId implements java.io.Serializable {
	...
	/** default constructor */
	public Wms_DefreportId() {
	}

	/** full constructor */
	public Wms_DefreportId(String reportId, BigDecimal subReportId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Wms_DefreportId))
			return false;
		Wms_DefreportId castOther = (Wms_DefreportId) other;
