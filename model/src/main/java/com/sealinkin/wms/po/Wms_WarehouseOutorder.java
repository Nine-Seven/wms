...
/**
 * WmsWarehouseOutorder entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "WMS_WAREHOUSE_OUTORDER")
public class Wms_WarehouseOutorder implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	// Fields

	private Wms_WarehouseOutorderId id;
	...
	/** default constructor */
	public Wms_WarehouseOutorder() {
	}

	/** minimal constructor */
	public Wms_WarehouseOutorder(Wms_WarehouseOutorderId id, Short priority,
	...
	public Wms_WarehouseOutorderId getId() {
		return this.id;
	}

	public void setId(Wms_WarehouseOutorderId id) {
		this.id = id;
	}
