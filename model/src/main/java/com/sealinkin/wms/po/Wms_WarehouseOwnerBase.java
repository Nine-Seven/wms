...
/**
 * WmsWarehouseOwnerBase entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "WMS_WAREHOUSE_OWNER_BASE")
public class Wms_WarehouseOwnerBase implements java.io.Serializable {
	...
	private Wms_WarehouseOwnerBaseId id;
	...
	/** default constructor */
	public Wms_WarehouseOwnerBase() {
	}

	/** minimal constructor */
	public Wms_WarehouseOwnerBase(Wms_WarehouseOwnerBaseId id, String groupNo,
			String subGroupNo) {
		this.id = id;
	...
	public Wms_WarehouseOwnerBaseId getId() {
		return this.id;
	}

	public void setId(Wms_WarehouseOwnerBaseId id) {
		this.id = id;
	}
