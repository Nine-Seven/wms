...
/**
 * WmsWarehouseRiordertype entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "WMS_WAREHOUSE_RIORDERTYPE")
public class Wms_WarehouseRiordertype implements java.io.Serializable {

	// Fields

	private Wms_WarehouseRiordertypeId id;
	...
	/** default constructor */
	public Wms_WarehouseRiordertype() {
	}

	/** minimal constructor */
	public Wms_WarehouseRiordertype(Wms_WarehouseRiordertypeId id,
			String overQtyFlag, String autoInstock, String advanceLocate,
			String deviceCompute) {
		this.id = id;
	...
	public Wms_WarehouseRiordertype(Wms_WarehouseRiordertypeId id,
			String overQtyFlag, String autoInstock, String advanceLocate,
			String deviceCompute, String orderRsv01, String orderRsv02,
			String orderRsv03, String orderRsv04, String orderRsv05,
			String orderRsv06, String orderRsv07, String orderRsv08,
			Integer strategyId, String rgstName, Date rgstDate,
			String updtName, Date updtDate, String mixOrdercheck,
			String rsvLabelFlag, String directCellFlag, String printCheckFlag,
			String autoCheckComfirFlag, String directCellNo) {
		this.id = id;
		this.overQtyFlag = overQtyFlag;
		this.autoInstock = autoInstock;
		this.advanceLocate = advanceLocate;
	...
	public Wms_WarehouseRiordertypeId getId() {
		return this.id;
	}

	public void setId(Wms_WarehouseRiordertypeId id) {
		this.id = id;
	}
