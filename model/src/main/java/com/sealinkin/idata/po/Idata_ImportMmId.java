...
/**
 * Idata_ImportMmId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Idata_ImportMmId  implements java.io.Serializable {
    ...
    /** default constructor */
    public Idata_ImportMmId() {
    }

    
    /** full constructor */
    public Idata_ImportMmId(String enterpriseNo, String SImportNo, String warehouseNo, String ownerNo) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Idata_ImportMmId) ) return false;
		 Idata_ImportMmId castOther = ( Idata_ImportMmId ) other; 
