...
/**
 * Idata_ImportSdhty entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="IDATA_IMPORT_SDHTY")

public class Idata_ImportSdhty  implements java.io.Serializable {
	...
	private Idata_ImportSdhtyId id;
    ...
    /** default constructor */
    public Idata_ImportSdhty() {
    }

	/** minimal constructor */
    public Idata_ImportSdhty(Idata_ImportSdhtyId id, String articleNo, Double packingQty, Double poQty, Double importQty, Double qcQty, String status, String itemType, String qcFlag) {
        this.id = id;
    ...
    /** full constructor */
    public Idata_ImportSdhty(Idata_ImportSdhtyId id, String articleNo, Double packingQty, Double poQty, Double importQty, Double qcQty, String checkName, String status, Date checkDate, String qcStatus, String outStockFlag, String outpaceArticleFlag, String itemType, Double planAcrossQty, Double checkAcrossQty, String qcFlag) {
        this.id = id;
        this.articleNo = articleNo;
        this.packingQty = packingQty;
        this.poQty = poQty;
    ...
    public Idata_ImportSdhtyId getId() {
        return this.id;
    }
    
    public void setId(Idata_ImportSdhtyId id) {
        this.id = id;
    }
    ...
    @Column(name="OUT_STOCK_FLAG", length=1)
    ...
    @Column(name="OUTPACE_ARTICLE_FLAG", length=1)
