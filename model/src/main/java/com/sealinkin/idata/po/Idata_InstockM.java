...
/**
 * IdataInstockM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "IDATA_INSTOCK_M")
public class Idata_InstockM implements java.io.Serializable {
	...
	/** default constructor */
	public Idata_InstockM() {
	}

	/** minimal constructor */
	public Idata_InstockM(Idata_InstockMId id, String status,
	...
	public Idata_InstockMId getId() {
		return this.id;
	}

	public void setId(Idata_InstockMId id) {
		this.id = id;
	}
