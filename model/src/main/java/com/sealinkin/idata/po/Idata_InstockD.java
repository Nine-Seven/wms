...
/**
 * IdataInstockD entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "IDATA_INSTOCK_D")
public class Idata_InstockD implements java.io.Serializable {
	...
	/** default constructor */
	public Idata_InstockD() {
	}

	/** minimal constructor */
	public Idata_InstockD(Idata_InstockDId id, Long directSerial,
			...
			String rgstName, Date rgstDate, String stockType,
			String stockValue, String autoLocateFlag, String serialNo) {
		this.id = id;
	...
	public Idata_InstockDId getId() {
		return this.id;
	}

	public void setId(Idata_InstockDId id) {
		this.id = id;
	}
