...
public class Idata_BsetDefbatch implements java.io.Serializable {
	...
	private Idata_BsetDefbatchId id;
	...
	/** default constructor */
	public Idata_BsetDefbatch() {
	}

	/** minimal constructor */
	public Idata_BsetDefbatch(Idata_BsetDefbatchId id, String batchType) {
		this.id = id;
		this.batchType = batchType;
	}

	/** full constructor */
	public Idata_BsetDefbatch(Idata_BsetDefbatchId id, String startTime, String endTime,
	...
	public Idata_BsetDefbatchId getId() {
		return this.id;
	}

	public void setId(Idata_BsetDefbatchId id) {
		this.id = id;
	}
