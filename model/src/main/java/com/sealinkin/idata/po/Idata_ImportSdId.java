...
/**
 * Idata_ImportSdId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Idata_ImportSdId  implements java.io.Serializable {
    ...
    /** default constructor */
    public Idata_ImportSdId() {
    }

    
    /** full constructor */
    public Idata_ImportSdId(String enterpriseNo, String SImportNo, String warehouseNo, String ownerNo, Short rowId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Idata_ImportSdId) ) return false;
		 Idata_ImportSdId castOther = ( Idata_ImportSdId ) other; 
