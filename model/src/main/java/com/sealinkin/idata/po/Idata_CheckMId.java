...
/**
 * IdataCheckMId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Idata_CheckMId implements java.io.Serializable {
	...
	/** default constructor */
	public Idata_CheckMId() {
	}

	/** full constructor */
	public Idata_CheckMId(String enterpriseNo, String checkNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Idata_CheckMId))
			return false;
		Idata_CheckMId castOther = (Idata_CheckMId) other;
