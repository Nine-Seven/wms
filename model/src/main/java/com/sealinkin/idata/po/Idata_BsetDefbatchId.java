 ...
 */
@Embeddable
public class Idata_BsetDefbatchId implements java.io.Serializable {
	...
	/** default constructor */
	public Idata_BsetDefbatchId() {
	}

	/** full constructor */
	public Idata_BsetDefbatchId(String warehouseNo, String batchNo,
			Date operateDate) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Idata_BsetDefbatchId))
			return false;
		Idata_BsetDefbatchId castOther = (Idata_BsetDefbatchId) other;
