...
/**
 * BdefDefsupplier entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "BDEF_DEFSUPPLIER")
public class Bdef_Defsupplier implements java.io.Serializable {

	// Fields

	private Bdef_DefsupplierId id;
	...
	/** default constructor */
	public Bdef_Defsupplier() {
	}

	/** minimal constructor */
	public Bdef_Defsupplier(Bdef_DefsupplierId id, String supplierName,
			Integer unloadFlag, String createFlag, String deptNo,
			String rgstName, Timestamp rgstDate) {
		this.id = id;
	...
	/** full constructor */
	public Bdef_Defsupplier(Bdef_DefsupplierId id, String realSupplierNo,
			String realSupplierName, String supplierName, String supplierAlias,
			String supplierAddress1, String supplierPhone1,
			String supplierFax1, String supplier1, String supplierAddress2,
			String supplierPhone2, String supplierFax2, String supplier2,
			String supplierRemark, String invoiceNo, String invoiceAddr,
			String invoiceHeader, String status, Integer unloadFlag,
			String areaNo, String createFlag, String supplierNoteCode,
			String deptNo, String rgstName, Date rgstDate,
			String updtName, Date updtDate, Integer rowId, String rsvVar1,
			String rsvVar2, String rsvVar3, String rsvVar4, String rsvVar5,
			String rsvVar6, String rsvVar7, String rsvVar8, Double rsvNum1,
	...
	public Bdef_DefsupplierId getId() {
		return this.id;
	}

	public void setId(Bdef_DefsupplierId id) {
		this.id = id;
	}
	...
	@Column(name = "SUPPLIER1", length = 15)
