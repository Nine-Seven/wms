...
/**
 * AcdataInstockM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "ACDATA_INSTOCK_M")
public class Acdata_InstockM implements java.io.Serializable {
	...
	/** default constructor */
	public Acdata_InstockM() {
	}

	/** minimal constructor */
	public Acdata_InstockM(Acdata_InstockMId id, String orderNo,
	...
	/** full constructor */
	public Acdata_InstockM(Acdata_InstockMId id, String orderNo, String sourceNo,
			String ownerAlias, String custAlias, String status, String remark,
	...
	public Acdata_InstockMId getId() {
		return this.id;
	}

	public void setId(Acdata_InstockMId id) {
		this.id = id;
	}
