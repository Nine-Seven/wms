...
public interface IRidata_CheckConfirmGsdService {
	...
	ExtListDataBo<Ridata_CheckPalTmpModel> queryCheckD(String enterpriseNo,String warehouseNo,
	...
	List<ComboxBo> getQuatity()throws Exception;
